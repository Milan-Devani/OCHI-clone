...
function Footer() {
    return (
        <div className='w-full pt-20 bg-[#f1f1f1]'>
            <div className='container mx-auto h-full px-[53.33px]'>
                <div className='row flex h-full'>
                    <div className='w-1/2 h-full flex flex-col justify-between'>
                        <div className='heading'>
                            <h2 className='uppercase text-[9vw] leading-none -mb-8'>eye-</h2>
                            <h2 className='uppercase text-[9vw] leading-none -mb-8'>opening</h2>
                        </div>
                    </div>
                    <div className='w-1/2'>
                        <div className='heading'>
                            <h2 className='uppercase text-[9vw] leading-none -mb-8'>PRESENTATIONS</h2>
                        </div>
                        <div className='w-full'>
                            <p className='w-full mt-14 mb-6'>S:</p>
                            {["instagram", "Behance", "facebook", "linkedin"].map((item, index) => (
                                <a className='block leading-8 capitalize text-[17px] underline'>{item}</a>
                            ))}
                        </div>
                        <div className='flex'>
                            <div className='part-1 w-5/6'>
                                <p className='w-full mt-14 mb-6'>S:</p>
                                <div className='w-full'>
                                    {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item, index) => (
                                        <a key={index} className={`block leading-8 capitalize text-[17px] underline ${index === 1 && 'mb-[30px]'}`} > {item}</a>
                                    ))}
                                </div>
                            </div>
                            <div className='part-2'>
                                <p className='w-full mt-14 mb-6'>M:</p>
                                <div className='w-full'>
                        ...
                        <div className='part-3'>
                            <p className='w-full h-full  mb-6'>E:</p>
                            <div className='w-full'>
                ...
                <div className='flex py-[42px] justify-between'>
                    ...
                    <div>
                        <p className='opacity-30'>© ochi design 2024. Legal Terms</p>
                    </div>
                    <div>
                        <p className='opacity-30'>Website by Milan devani</p>
                    </div>
                </div>
            </div>
        </div>
